export const metadata = { title: 'Termini di Servizio · PointLab' };
  ...
  return (
    <div className="wrap" style={{maxWidth: 760}}>
      <div className="card">
        ...
        <p>
          PointLab è una piattaforma che consente a maestri di tennis di registrare partite dei
        ...
        <ul>
          <li>avere il diritto di raccogliere e inserire in PointLab i dati di ciascun allievo che registra;</li>
          <li>aver ottenuto, se l'allievo è minorenne, il consenso del genitore o tutore legale al trattamento dei suoi dati tramite PointLab;</li>
        ...
        <p>PointLab si riserva il diritto di sospendere account che violano questi impegni.</p>
        ...
        <ul>
          ...
          <li>I pagamenti sono gestiti da Stripe; PointLab non ha accesso ai dati completi della carta di pagamento.</li>
        ...
        <p>
          PointLab è uno strumento di supporto per l'allenamento: statistiche, punteggi e report
          dipendono dai dati inseriti manualmente dal maestro durante la partita e possono contenere
          imprecisioni. PointLab non fornisce consulenza medica, sportiva o professionale, e non è
          responsabile di decisioni prese sulla base dei dati registrati. Nei limiti consentiti dalla
          legge, la responsabilità di PointLab per eventuali danni è limitata all'importo pagato dal
          maestro negli ultimi 12 mesi.
        </p>

        <h2 style={{fontSize:16, marginTop:24}}>7. Proprietà intellettuale</h2>
        <p>
          Il software, il marchio "PointLab" e i contenuti della piattaforma sono di proprietà di
          [RAGIONE SOCIALE] o concessi in licenza. I dati inseriti da ciascun maestro (allievi,
          partite) restano di sua proprietà; PointLab li tratta solo per fornire il servizio.
        </p>

        <h2 style={{fontSize:16, marginTop:24}}>8. Sospensione e chiusura dell'account</h2>
        <p>
          PointLab può sospendere o chiudere un account in caso di violazione di questi termini, uso
        ...
        <p>
          PointLab può aggiornare funzionalità, prezzi e questi termini. Le modifiche sostanziali
