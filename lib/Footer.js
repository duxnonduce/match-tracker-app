...
export default function Footer() {
  return (
    <footer style={{textAlign:'center', padding:'28px 16px', fontSize:12, color:'var(--muted)'}}>
      ...
      <div style={{marginTop:10, display:'flex', alignItems:'center', justifyContent:'center', gap:6, opacity:0.6}}>
        <span style={{fontSize:10.5}}>Tecnologia by</span>
        <img src="/branding/pointlab-logo.png" alt="PointLab" style={{height:14, width:'auto'}} />
      </div>
    </footer>
  );
}
